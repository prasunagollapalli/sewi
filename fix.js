...
// Find the start of the corrupted navigation section
let startIdx = content.indexOf('  // --- Navigation Logic ---');
if (startIdx !== -1) {
    let cleanNav =   // --- Navigation Logic ---
  ...
  checkAuth();
    ...
    content = content.substring(0, startIdx) + cleanNav + '\n';
